...
def down():
    ...
    if "https://abema.tv/video/" in down_link:
        ...
        while True:
                ...
                if "https://abema.tv/video/" in down_link:
                    ...
                    i = 1
                    break
                elif "https://" in down_link:
                    if "pornhub.com/" in down_link:
                        i = 1
                elif "https://youtu.be/" in down_link:
                    i = 1
                    break
    ...
    if os.path.exists(os.path.join(user_folder,"Videos")) == True:
        karento = os.path.join(user_folder,"Videos")
    elif os.path.exists(os.path.join(user_folder,"ビデオ")) == True:
        karento = os.path.join(user_folder,"ビデオ")
    else:
        karento = os.path.expanduser('~')
        print("ユーザーフォルダにダウンロードされます")
